    ...
    data(){
        return {
            detailMovie : {
                ...
                'dra' : '在一座山间小城中，一对低配劫匪、一个落魄的泼皮保安、一个身体残疾却性格彪悍的残毒舌女以及一系列生活在社会不同轨迹上的小人物，在一个貌似平常的日子里，因为一把丢失的老枪和一桩当天发生在城中的乌龙劫案，从而被阴差阳错地拧到一起，发生的一幕幕令人啼笑皆非的荒诞喜剧。',
                'photos' : [
                    'http://p0.meituan.net/w.h/movie/a3d6ca3bdd5b0ddd7016acff9a9f2f2e2805813.jpg',
                    'http://p0.meituan.net/w.h/movie/a3d6ca3bdd5b0ddd7016acff9a9f2f2e2805813.jpg',
                    'http://p0.meituan.net/w.h/movie/a3d6ca3bdd5b0ddd7016acff9a9f2f2e2805813.jpg',
                    'http://p0.meituan.net/w.h/movie/a3d6ca3bdd5b0ddd7016acff9a9f2f2e2805813.jpg'
                ]
...
<style scoped>
#detailContrainer{ position: absolute; top: 0; left: 0; z-index: 100; width: 100%; min-height: 100%; background: #ffffff}
#detailContrainer.slider-enter-active{ animation: 0.3s slideMove; }
@keyframes slideMove {
